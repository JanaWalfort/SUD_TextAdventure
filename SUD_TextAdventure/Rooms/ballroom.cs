    ...
    public class ballroom
    {
        ...
        public string run()
        {
            Console.WriteLine(
                ...
                "\nWas willst Du tun? \nUmsehen? \nZum Balkon? \nZurück in den Garten? \nZurück in den Flur?"); // Besser glastür und holztür?
            String[] validInput = {"umsehen", "balkon", "garten", "flur"}; // Add "rüstung"?
            ...
            switch (confirmation)
            {
                case "umsehen":
                    ...
                    {
                        Console.WriteLine(
                            "Die eine Ritterrüstung fällt fast auseinander und Du entdeckst ein Schwert, das Dir auf Deiner Flucht vielleicht weiterhelfen wird!");
                ...
                case "garten":
                    Console.WriteLine(
                        "Der Garten in den Du hineingehst ist wundervoll. Vielleicht gibt es hier eine Fluchtmöglichkeit.");
                    return "garden";
                case "flur":
